                ...
                <div class="row gutters-sm">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    {{-- <img src="images/user.png') }}" alt="Admin" class="rounded-circle"> --}}
                                    <div class="mt-3">
                    ...
                    <div class="col-md-8">
                        <div class="card bordered px-3">
                                ...
                                <div class="card mb-3 mt-3">
                                    ...
                                    <div class="box p-3">
                                        ...
                                        <div class="img-box">
                                            <div id="myCarousel" class="carousel slide" data-bs-ride="true">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        {{-- <img class="d-block w-100" src="images/ads/{{ $ad->photo1 }}"
                                                            alt="First slide"> --}}
                                                        <img style="height: 320px;"
                                                            src="images/ads/{{ $ad->photo1 }}"
                                                            alt="">
                                                    </div>
                                                    <div class="carousel-item">
                                                        {{-- <img class="d-block w-100" src="images/ads/{{ $ad->photo2 }}"
                                                            alt="Second slide"> --}}
                                                        <img style="height: 320px;"
                                                            src="images/ads/{{ $ad->photo2 }}"
                                                            alt="">
                                                    </div>
                                                    <div class="carousel-item">
                                                        {{-- <img class="d-block w-100" src="images/ads/{{ $ad->photo3 }}"
                                                            alt="Third slide"> --}}
                                                        <img style="height: 320px;"
                                                            src="images/ads/{{ $ad->photo3 }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            ...
                                            {{-- <img style="height: 320px;" src="images/ads/{{ $ad->photo1 }}"
                                                    alt=""> --}}
                                        </div>
                            ...
                            <!-- approved ads -->
                            {{-- <div class="card mb-3 mt-3">
                                    <img src="images/h-1.jpg') }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                ...
                                <div class="card mb-3 mt-3">
                                    <img src="images/h-2.jpg') }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a natural
                                            lead-in to additional content. This content is a little bit longer.</p>
