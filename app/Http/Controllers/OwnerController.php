...
class OwnerController extends Controller
{
    ...
    public function placeAd(Request $request, $id)
    {
        ...
        $request->nid->move('/images/verification', $nid);
        $request->bill->move('/images/verification', $bill);
    ...
    public function paymentAdd(Request $request)
    {
        ...
        $request->trximage->move('/images/payments', $trximg);
